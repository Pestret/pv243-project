...
insert into Product (id, name, description, price, available) values (1, 'Praskaci kulicky', 'Vyborne na straseni duchodcu', 2, 150)
insert into Product (id, name, description, price, available) values (2, 'Papinak s dusenou mrkvi', 'Boston IMPROVED', 5, 50)
insert into Product (id, name, description, price, available) values (3, 'Tlacenka se strelnym prachem', 'Nom nom nom', 25, 33)
